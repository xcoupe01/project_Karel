/**
 * Czech language for the Karel 3D application
    ...
    return {
        ...
        "UI" : {
            ...
            "LoadFromCloudDialog": {
                ...
                "dialogText": "Provede načtení pozice ze serveru, níže je seznam tvých uložených pozic. Kliknutím na červený text uložení se načte pozice.",
                "noAvalibleSaves": "Nebyly nalezeny žádné uložené pozice"
            },
            "SaveToCloudDialog": {
                "dialogTitle": "Ulož na server",
                "dialogText": "Ulož svoji pozici na server. Níže je seznam tvých uložených pozic, Pokud uložíš pozici pod stejným názvem jako je již některá uložená pozice, bude přepsána.",
                "saveButton": "Ulož",
        ...
        "consoleLogs": {
            ...
            "internalError": "Nastala vnitřní chyba aplikace",
            ...
            "blockConversionError": "Nastala chyba během transformace na bloky",
            "corruptedSaveFile": "Načítaný soubor je poškozený",
            "noFileToLoad": "Nebyl vybrán soubor pro načtení",
            ...
            "blockAlreadyPresentError": "Políčko je již v místnosti",
